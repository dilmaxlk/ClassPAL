...
<html>
  <head>
    ...
    <title>Student Access Key</title>
  ...
  <body>
        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <h2 class="page-header">
              <i class="fa fa-users"></i> Report: Students Access Key | Course Name: 
              <?php 
    ...
    $stmt = $db->prepare("SELECT cp_subj_allo.sa_stu_student_id, cp_subj_allo.sa_stu_student_Name, cp_students.stu_accesskey FROM `cp_subj_allo` INNER JOIN `cp_students` ON cp_students.stu_studentID = cp_subj_allo.sa_stu_student_id WHERE (cp_subj_allo.sa_batch_no LIKE '%{$SearchKey}%') AND cp_subj_allo.sa_subj_id = $Subj_ID ORDER BY cp_subj_allo.sa_stu_student_id ASC");
    $stmt->bind_result($sa_stu_student_id, $sa_stu_student_Name, $stu_accesskey );
    $stmt->execute();
