...
<html>
 ...
 ?>
            <h2 class="page-header">
              <i class="fa fa-users"></i> Report: All Registered Students | Course Name: <?php echo $Subj_name; ?>
