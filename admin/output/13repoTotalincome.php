...
$stmt_sel_Rows = $db->prepare("SELECT COUNT(pay_id) FROM cp_payments WHERE pay_id!=1 AND pay_id!=2 AND pay_id!=3 AND pay_id!=4 AND pay_id!=5 AND pay_id!=6 AND pay_id!=7 AND pay_id!=8 AND pay_id!=9 AND pay_id!=10 AND pay_id!=11 AND pay_id!=12 ");
...
while ($stmt_select_sp_user->fetch()){ 
 ...
 if($cp_users_sp_id == 1){
    ...
    $stmt->bind_result($pay_id, $Pay_stu_studentID, $pay_student_name, $pay_subj_id, $pay_paymentdate, $pay_paymentmonth, $pay_cos_fee, $pay_cos_admi, $pay_cos_total, $pay_misc_pay_description, $pay_misc_amount);
    $stmt->execute();
        ...
        <div class="row">      
          <div class="col-xs-6">
            ...
            ?>
                    ...
                    <th>Total Course Income: <?php echo $ShowTotalIncome; ?></th>
            ...
            ?>
                    ...
                    <th>Total Income: <?php echo $ShowTotalIncome + $TotalMiseIncome; ?></th>
