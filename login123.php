...
?>
                ...
                <a style="margin-top: 5px; display: <?php echo $display_none_value; ?>;" href="studentreg.php?StudentID=<?php echo $AutoNuber; ?>" class="btn btn-flat btn-lg btn-danger">ලියාපදිංචිවන්න | Register Now </a>
